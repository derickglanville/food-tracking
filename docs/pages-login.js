...
if(!firebase.apps.length)firebase.initializeApp({apiKey:'AIzaSyC1s8rJbIlukPwvlDi8KnlAHyFjYiqFd14',authDomain:'glanville-issue-tracker.firebaseapp.com',projectId:'glanville-issue-tracker'});
